        ...
        <div className="grid grid-cols-1 px-6 gap-3 gap-y-8 sm:grid-cols-2 lg:grid-cols-4">
          {
            homeSix[0].map((li, index) =>{
              ...
              return (
                ...
                >
                  <div className="flex w-[150px] h-[150px] justify-center items-center mx-auto bg-indigo-400 rounded-full">
                    <img src={url} className="w-[140px] h-[140px] rounded-full mx-auto" alt="agent broker" />
                    {/* { <FaUserCircle className="text-white" size={"150px"}/> } */}
                  </div>
